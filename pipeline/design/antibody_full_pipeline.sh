...
# ============================================================================
# This script runs the complete antibody design workflow:
...
#
# Usage: bash scripts/examples/antibody_full_pipeline.sh
# ============================================================================
...
# Input files
TARGET_PDB="/home/ozangocmen/RFantibody/CLDN4/9cmiA.pdb"       # Target antigen
FRAMEWORK_PDB="/home/ozangocmen/RFantibody/scripts/examples/example_inputs/hu-4D5-8_Fv.pdb" # Antibody framework

# Output directory (will be created if it doesn't exist)
OUTPUT_DIR="/home/ozangocmen/RFantibody/CLDN4/output_CLDN4"

# RFdiffusion parameters
NUM_DESIGNS=100                        # Number of backbone designs to generate
DESIGN_LOOPS="L1:8-13,L2:7,L3:9-11,H1:7,H2:6,H3:5-13"        # CDR loop lengths to design
HOTSPOTS="A45,A46,A146,A147,A47,A149,A150,A151,A152,A153,A158"               # Target residues to focus binding (chain A)
DIFFUSER_T=50                           # Number of diffusion timesteps

# ProteinMPNN parameters
NUM_SEQS=10                              # Number of sequences per backbone
...
echo "=============================================="
echo "Antibody Design Pipeline for CLDN4"
echo "=============================================="
